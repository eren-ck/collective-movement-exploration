...
function setNetworkHierarchy(value, network_id) {
    ...
    else if (Object.keys(networkHierarchy).length <= __WEBPACK_IMPORTED_MODULE_2__hierarchy_js__["c" /* maxNumberHierarchies */]) {
...
/* unused harmony export drawDendrogram */
/* harmony export (immutable) */ __webpack_exports__["a"] = addHierarchyButton;
/* harmony export (immutable) */ __webpack_exports__["d"] = removeHierarchyButton;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__explore_js__ = __webpack_require__(0);
...
/* harmony export (immutable) */ __webpack_exports__["c"] = maxNumberHierarchies;
...
function h_listeners() {
    ...
    $('.hiearchy-checkbox').on('change', function() {
        ...
        if (checked) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_9__hierarchy_js__["d" /* removeHierarchyButton */])(id);
